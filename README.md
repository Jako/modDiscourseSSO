...
This extra requires MODX 2.3+ and PHP5.5+. It still works with MODX 3.x, Discourse 3.x. and PHP 8.3.
...
- Fill out the SSO settings within Discourse as shown here: https://meta.discourse.org/t/official-single-sign-on-for-discourse-sso/13045
    ...
    - The sso_url should be the full URL where your ```[[!discourse? &loginPage=`<login_id>`]]``` snippet resides. 
